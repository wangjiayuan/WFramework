...
-(void)prepareLayout
{
    ...
    self.headerReferenceSize = CGSizeMake(self.collectionView.bounds.size.width, 65.0f);//头部视图的框架大小
    
    self.itemSize = CGSizeMake(self.collectionView.bounds.size.width/7.0f, 70.0f);//每个cell的大小
