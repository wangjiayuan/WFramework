...
#define CATDayLabelWidth  (([UIScreen mainScreen].bounds.size.width-40.0f)/7.0f)
...
- (void)setup
{
    ...
    //月份
    UILabel *masterLabel = [[UILabel alloc] initWithFrame:CGRectMake(10.f, 10.0f, [UIScreen mainScreen].bounds.size.width-20.0f, 30.f)];
    ...
    self.masterLabel.textColor = Head_COLOR_THEME;
    ...
    self.day1OfTheWeekLabel.textColor = Head_COLOR_THEME1;
    ...
    self.day2OfTheWeekLabel.textColor = Head_COLOR_THEME;
    ...
    self.day3OfTheWeekLabel.textColor = Head_COLOR_THEME;
    ...
    self.day4OfTheWeekLabel.textColor = Head_COLOR_THEME;
    ...
    self.day5OfTheWeekLabel.textColor = Head_COLOR_THEME;
    ...
    self.day6OfTheWeekLabel.textColor = Head_COLOR_THEME;
    ...
    self.day7OfTheWeekLabel.textColor = Head_COLOR_THEME1;
