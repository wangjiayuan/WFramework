...
- (void)commonInit
{
    ...
    self.zk_itemDefaultColor = ColorWithRGB(102, 102, 102);
    self.itemStyleSelectedColor = ColorWithRGB(255, 118, 19);
    switch (self.segmentStyle) {
        case ZKSegmentLineStyle:
            self.zk_itemSelectedColor = ColorSystem(whiteColor);
            break;
    ...
    self.segmentBackgroundColor = ColorSystem(whiteColor);
